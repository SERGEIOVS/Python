...
bgmusic = pg.mixer.music.load( 'Музыка/01 Damned.mp3 ' )
...
bgimage_height = 30
bgimage_speed = 5
bgimage = pg.image.load( 'задний фон/background_1.png' )
...
bgimage1_height = 30
bgimage1_speed = 5
bgimage1 = pg.image.load( 'задний фон/background_1.png' )

hero_width = 100
hero_height = 180
hero_x = screen_width /  2 - hero_width  / 2
hero_y = screen_height / 2 - hero_height / 2
hero_speed = 3
hero_health = 10
hero_armor = 10
hero_current_armor = 10
hero_max_armor = 10
hero_current_health = 10
hero_max_health = 10
hero_anmations = [
...
screen_height - 50 , screen_height - 50 , screen_height - 50 , screen_height - 50 , screen_height - 50 ,
screen_height - 50 , screen_height - 50 , screen_height - 50 , screen_height - 50 , screen_height - 50

]

hero_belt_inventory_cells_images = [
pg.image.load( 'интерфейс/иконки/inventory_cell.png' ) , 
pg.image.load( 'интерфейс/иконки/inventory_cell.png' ) , 
pg.image.load( 'интерфейс/иконки/inventory_cell.png' ) , 
pg.image.load( 'интерфейс/иконки/inventory_cell.png' ) , 
pg.image.load( 'интерфейс/иконки/inventory_cell.png' ) ,
...
pg.image.load( 'интерфейс/иконки/big_inventory_cell.png' ) , 
...
hero_backpack_inventory_cells_y_list[ 1 ] + 20 ,
...
1400  , 1700  , 1900   , 2100   , 2300 , 2500  , 2800 , 3000  , 3100  , 3200 , 3300 , 3550 , 3700  
...
def draw_level() :
    ...
    screen.blit( bgimage ,   ( -camera.rect[ 0 ] ,         -camera.rect[ 1 ] ) )

    screen.blit( bgimage1 ,  ( -camera.rect[ 0 ] + 10300 , -camera.rect[ 1 ] ) )
    ...
    #for i in range(len(closed_achievements)):
     #   screen.blit( , (achievements_menu.x + 50 , achievements_menu.y + ( 120 + i * 30 ) ) ) 

...
partitions = ['Исторические события' , 'Исторические деятели' , 'Изобретения','Исторические факты']

partition = partitions[ 0 ]

text_color = ( 180 , 0 , 0 )

text1 = f1.render( partitions[0] , True , text_color )
...
while True:
    ...
    for event in pg.event.get() :
        ...
        if event.type == pg.KEYDOWN :
            ...
            if event.key == pg.K_1 :
                text1 = f1.render( partition  , True , text_color )
                current_color_num = 0
